...
const PROVINCES = [
  ...
  { id: 'he', name: '河北', rates: { c1: 0.4, c2: 0.7, c3: 1.1, c4: 1.36 }, note: '河北高速集团多数路段公开表：一类 0.40、二类 0.70、三类 1.10、四类 1.36。石黄等路段一类 0.30，新建改扩建更高。' },
  { id: 'sx', name: '山西', rates: { c1: 0.36, c2: 0.54, c3: 0.87, c4: 1.14 }, note: '多数已运营高速执行乙类公开表：一类 0.36、二类 0.54、三类 0.87、四类 1.14。甲类路段一类常见 0.39，晋阳等丁类一类 0.30；桥隧另计。' },
  ...
  { id: 'js', name: '江苏', rates: { c1: 0.45, c2: 0.675, c3: 0.9, c4: 0.9 }, note: '联网高速常见公开档：一类 0.45、二类 0.675、三类 0.90，四类与三类同价。部分路段一类 0.50 或 0.55。' },
  ...
  { id: 'fj', name: '福建', rates: { c1: 0.55, c2: 1.1, c3: 1.54, c4: 1.65 }, note: '厅里涉企清单常见公开档：一类 0.55、二类 1.10、三类 1.54、四类 1.65。还贷路段一类还有 0.50，新建常见 0.60。' },
  ...
  { id: 'hb', name: '湖北', rates: { c1: 0.5, c2: 0.75, c3: 1, c4: 1.25 }, note: '省政府定价目录五档中的常见档：一类 0.50、二类 0.75、三类 1.00、四类 1.25。另有 0.40 / 0.60 / 0.80 / 1.00 和更高档。' },
  { id: 'hn', name: '湖南', rates: { c1: 0.4, c2: 0.7, c3: 1, c4: 1.2 }, note: '造价较低的四车道为此档；较高造价或六车道多为 0.50 / 0.80 / 1.10 / 1.30。' },
  { id: 'gd', name: '广东', rates: { c1: 0.45, c2: 0.675, c3: 0.9, c4: 0.9 }, note: '四车道公开单价：一类 0.45、二类 0.675、三类 0.90；40 座以上按三类计，故四类同为 0.90。六车道一类 0.60。' },
  ...
  { id: 'yn', name: '云南', rates: { c1: 0.5, c2: 1, c3: 1.5, c4: 2 }, note: '普通路段一类不超过 0.50，对应公开档二类 1.00、三类 1.50、四类 2.00。500 米以上桥隧另计。' },
  ...
  { id: 'gs', name: '甘肃', rates: { c1: 0.35, c2: 0.55, c3: 0.8, c4: 1.25 }, note: '多数高速公开表：一类 0.35、二类 0.55、三类 0.80、四类 1.25。宝天、十天、成武、武罐、临合为 0.50 / 0.60 / 0.90 / 1.30。' },

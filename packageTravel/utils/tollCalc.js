...
const PROVINCES = [
  ...
  { id: 'he', name: '河北', rates: { c1: 0.31, c2: 0.44, c3: 0.57, c4: 0.75 }, note: '一类 0.31、二类 0.44、三类 0.57、四类 0.75。同一省不同路段仍可能不同。' },
  ...
  { id: 'js', name: '江苏', rates: { c1: 0.45, c2: 0.675, c3: 0.9, c4: 0.9 }, note: '一类 0.45、二类 0.675、三类 0.90，四类与三类同价。同一省不同路段仍可能不同。' },
  ...
  { id: 'sd', name: '山东', rates: { c1: 0.45, c2: 0.6, c3: 0.8, c4: 1 }, note: '一类 0.45、二类 0.60、三类 0.80、四类 1.00。同一省不同路段仍可能不同。' },
  ...
  { id: 'hb', name: '湖北', rates: { c1: 0.4, c2: 0.6, c3: 0.8, c4: 1.1 }, note: '一类 0.40、二类 0.60、三类 0.80、四类 1.10。同一省不同路段仍可能不同。' },
  ...
  { id: 'gd', name: '广东', rates: { c1: 0.6, c2: 0.9, c3: 1.2, c4: 1.8 }, note: '一类 0.60、二类 0.90、三类 1.20、四类 1.80。同一省不同路段仍可能不同。' },
  ...
  { id: 'qh', name: '青海', rates: { c1: 0.4, c2: 0.57, c3: 0.9, c4: 1.15 }, note: '一类 0.40、二类 0.57、三类 0.90、四类 1.15。同一省不同路段仍可能不同。' },
